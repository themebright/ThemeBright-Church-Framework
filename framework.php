 ...
 */
if ( ! defined( 'TBF_DIR' ) )                 define( 'TBF_DIR',                trailingslashit( get_template_directory() ) . trailingslashit( basename( dirname( __FILE__ ) ) ) ); // framework directory (where this file is)
