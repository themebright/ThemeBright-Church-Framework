...
if ( ! defined( 'TBF_INC_DIR' ) )             define( 'TBF_INC_DIR',            trailingslashit( TBF_DIR ) . 'includes' );         // framework includes directory
if ( ! defined( 'TBF_ADMIN_DIR' ) )           define( 'TBF_ADMIN_DIR',          trailingslashit( TBF_INC_DIR ) . 'admin' );        // framework admin directory
if ( ! defined( 'TBF_CLASS_DIR' ) )           define( 'TBF_CLASS_DIR',          trailingslashit( TBF_INC_DIR ) . 'classes' );      // framework classes directory
if ( ! defined( 'TBF_LIB_DIR' ) )             define( 'TBF_LIB_DIR',            trailingslashit( TBF_INC_DIR ) . 'library' );      // framework libraries directory
if ( ! defined( 'TBF_ASSETS_DIR' ) )          define( 'TBF_ASSETS_DIR',         trailingslashit( TBF_DIR ) . 'assets' );           // framework assets directory
if ( ! defined( 'TBF_CSS_DIR' ) )             define( 'TBF_CSS_DIR',            trailingslashit( TBF_ASSETS_DIR ) . 'css' );       // framework CSS directory
if ( ! defined( 'TBF_JS_DIR' ) )              define( 'TBF_JS_DIR',             trailingslashit( TBF_ASSETS_DIR ) . 'js' );        // framework JavaScript directory
if ( ! defined( 'TBF_IMG_DIR' ) )             define( 'TBF_IMG_DIR',            trailingslashit( TBF_ASSETS_DIR ) . 'img' );       // framework images directory
...
if ( ! defined( 'TBF_THEME_CSS_DIR' ) )       define( 'TBF_THEME_CSS_DIR',      trailingslashit( TBF_THEME_ASSETS_DIR ) . 'css' ); // framework CSS directory
if ( ! defined( 'TBF_THEME_JS_DIR' ) )        define( 'TBF_THEME_JS_DIR',       trailingslashit( TBF_THEME_ASSETS_DIR ) . 'js' );  // framework JavaScript directory
if ( ! defined( 'TBF_THEME_IMG_DIR' ) )       define( 'TBF_THEME_IMG_DIR',      trailingslashit( TBF_THEME_ASSETS_DIR ) . 'img' ); // framework images directory
